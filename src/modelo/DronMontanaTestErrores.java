...
public class DronMontanaTestErrores {
	 ...
	 */
	public DronMontanaTestErrores(int distancia, boolean estadoDron, String descripcionCaso) {
	...
	public void testTiempoRespuestaDebeLanzarExcepcion() {
		// creamos el objeto
		DronMontana dron = new DronMontana(1, 60, 50, estadoDron, 5);
